...
####################################################################
# Compare between Hungarian and modified Hungarian on sythetic data#
####################################################################
...
i=1
#results_hungarian_oper_syn = []
results_hungarian_time_syn = []
...
for sample,l in settings:
 ...
 #results_hungarian_oper_syn.append(storeHungarianoper)
 time0=time.time()
 row_ind, col_ind = linear_sum_assignment(costrep.max()-costrep)
 storeHungariantime = time.time()-time0
 results_hungarian_time_syn.append(storeHungariantime)
...
i=1
results_hungarian_oper_z_syn = []
results_hungarian_time_z_syn = []
...
# solution, storeHungarianoper = track_Hungarian(costrep.max()-costrep)
# results_hungarian_oper_z_syn.append(storeHungarianoper)
 time0=time.time()
 row_ind, col_ind = linear_sum_assignment(costrep.max()-costrep)
 storeHungariantime = time.time()-time0
 results_hungarian_time_z_syn.append(storeHungariantime)
...
for i in [0,1]:
    ...
    results_hungarian_oper_reshape = np.array(results_hungarian_oper_z_syn).reshape(2,70)[i].reshape(7,10)
...
for i in [0,1]:
    ...
    results_hungarian_oper_reshape = np.array(results_hungarian_oper_syn).reshape(2,70)[i].reshape(7,10)
    results_hungarian_oper_worst = results_hungarian_oper_reshape.max(axis=1)
    results_hungarian_oper_best = results_hungarian_oper_reshape.min(axis=1)
    results_hungarian_oper_average = results_hungarian_oper_reshape.mean(axis=1)
...
#plt.savefig("synoper.pdf".format(l[i]), format="pdf")
plt.figure()
...
for i in [0,1]:
    ...
    results_hungarian_time_reshape = np.array(results_hungarian_time_z_syn).reshape(2,70)[i].reshape(7,10)
...
for i in [0,1]:
    ...
    results_hungarian_time_reshape = np.array(results_hungarian_time_syn).reshape(2,70)[i].reshape(7,10)
    results_hungarian_time_worst = results_hungarian_time_reshape.max(axis=1)
    results_hungarian_time_best = results_hungarian_time_reshape.min(axis=1)
    results_hungarian_time_average = results_hungarian_time_reshape.mean(axis=1)
...
plt.savefig("syntime.pdf".format(l[i]), format="pdf")
plt.figure()
