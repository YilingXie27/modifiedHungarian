...
#################################################################
# Compare between modified Hungarian and Sinkhorn on breast data#
#################################################################
...
i=1
results_sinkhorn_oper_breast = []
results_sinkhorn_time_breast = []
...
for sample,l in settings:
 ...
 results_sinkhorn_oper_breast.append(storesinkhornoper)
 results_sinkhorn_time_breast.append(storesinkhorntime)
...
#%%create list to store the results
i=1
results_sinkhorn_oper_z_breast = []
results_sinkhorn_time_z_breast = []
...
for sample,l in settings:
 ...
 solution, storesinkhornoper = sinkhorn_log(np.array(a), np.array(b), cost, reg=0.1, acc=0.0001)
 storesinkhorntime = time.time()-time0
 results_sinkhorn_oper_z_breast.append(storesinkhornoper)
 results_sinkhorn_time_z_breast.append(storesinkhorntime)
...
for i in [0,1]:
    ...
    results_sinkhorn_oper_reshape = np.array(results_sinkhorn_oper_z_breast).reshape(2,70)[i].reshape(7,10)
...
for i in [0,1]:
    ...
    results_sinkhorn_oper_reshape = np.array(results_sinkhorn_oper_breast).reshape(2,70)[i].reshape(7,10)
    results_sinkhorn_oper_worst = results_sinkhorn_oper_reshape.max(axis=1)
    results_sinkhorn_oper_best = results_sinkhorn_oper_reshape.min(axis=1)
    results_sinkhorn_oper_average = results_sinkhorn_oper_reshape.mean(axis=1)
...
#plt.savefig("Breastopersink.pdf".format(l[i]), format="pdf")
plt.figure()
...
for i in [0,1]:
    ...
    results_sinkhorn_time_reshape = np.array(results_sinkhorn_time_z_breast).reshape(2,70)[i].reshape(7,10)
...
for i in [0,1]:
    ...
    results_sinkhorn_time_reshape = np.array(results_sinkhorn_time_breast).reshape(2,70)[i].reshape(7,10)
    results_sinkhorn_time_worst = results_sinkhorn_time_reshape.max(axis=1)
    results_sinkhorn_time_best = results_sinkhorn_time_reshape.min(axis=1)
    results_sinkhorn_time_average = results_sinkhorn_time_reshape.mean(axis=1)
...
#plt.savefig("Breasttimesink.pdf".format(l[i]), format="pdf")
plt.figure()
